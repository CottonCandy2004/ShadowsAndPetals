...
public final class RegFluidBuilder {
    ...
    public RegFluidBuilder clientModel(ResourceLocation stillTexture, ResourceLocation flowingTexture, int tintColor) {
    ...
    public RegisteredFluid register() {
        ...
        if (liquidBlockProperties != null) {
            registration.block = blockRegistry.registerBlock(
                    ...
                    liquidBlockProperties.apply(BlockBehaviour.Properties.of())
            );
        }
        ...
        if (registration.block != null) {
            ...
            ResourceLocation particleTexture = stillTexture != null
                    ? stillTexture
