...
public final class SandExcavationCooldownServerDataProvider implements IServerDataProvider<BlockAccessor> {
    ...
    public static final SandExcavationCooldownServerDataProvider INSTANCE = new SandExcavationCooldownServerDataProvider();
    ...
    public void appendServerData(CompoundTag data, BlockAccessor accessor) {
        if (!(accessor.getLevel() instanceof ServerLevel level)
                || !accessor.getBlockState().is(Blocks.SAND)) {
            return;
        }
