...
public class ModRockeryModelProvider implements DataProvider {
    ...
    private static final String PARTICLE_TEXTURE = ResourceLocation.withDefaultNamespace("block/stone").toString();
    ...
    private List<CompletableFuture<?>> generateObjParts(
        ...
        ResourceLocation materialId = ShadowsAndPetals.asResource("block/rock/" + modelDirectory + "/material");
        ...
        for (ObjModelCutter.Part part : cut.parts()) {
            ...
            ResourceLocation modelId = ShadowsAndPetals.asResource("block/rock/" + modelDirectory + "/" + partName);
