...
public final class RigDefinition {
    ...
    private RigDefinition(ResourceLocation id, List<Bone> bones, Map<String, Integer> indices) {
        this.id = id;
    ...
    public static RigDefinition create(ResourceLocation id, List<BoneSpec> specs) {
        if (specs.isEmpty()) {
    ...
    private static void validateAcyclic(ResourceLocation id, List<Bone> bones) {
