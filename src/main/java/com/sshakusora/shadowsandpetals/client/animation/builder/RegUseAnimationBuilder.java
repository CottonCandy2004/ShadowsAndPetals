...
public final class RegUseAnimationBuilder {
     ...
     */
    public RegUseAnimationBuilder rig(ResourceLocation id) {
     ...
     */
    public RegUseAnimationBuilder controller(ResourceLocation id) {
     ...
     */
    public RegUseAnimationBuilder clip(ResourceLocation id) {
    ...
    public UseAnimationProfile register() {
        ...
        ResourceLocation conventionalResourceId = conventionalResourceId();
    ...
    private ResourceLocation conventionalResourceId() {
