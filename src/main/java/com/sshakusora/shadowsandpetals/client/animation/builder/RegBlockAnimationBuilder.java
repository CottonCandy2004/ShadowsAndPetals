...
public final class RegBlockAnimationBuilder {
    ...
    public RegBlockAnimationBuilder rig(ResourceLocation id) {
    ...
    public RegBlockAnimationBuilder controller(ResourceLocation id) {
    ...
    public RegBlockAnimationBuilder clip(ResourceLocation id) {
    ...
    public BlockAnimationDefinition register() {
        ...
        ResourceLocation conventionalId = ResourceLocation.fromNamespaceAndPath(
