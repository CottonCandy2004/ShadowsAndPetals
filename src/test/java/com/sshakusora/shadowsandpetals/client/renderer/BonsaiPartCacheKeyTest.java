...
class BonsaiPartCacheKeyTest {
    private static final ResourceLocation OAK = ResourceLocation.withDefaultNamespace("oak_log");
    private static final ResourceLocation MAPLE = ResourceLocation.withDefaultNamespace("maple_log");

    @Test
    void sameStateProducesEqualKeys() {
        BonsaiPartCacheKey a = new BonsaiPartCacheKey(
                BonsaiBlockEntity.Shape.SEMI_CASCADE, false, OAK, ResourceLocation.withDefaultNamespace("oak_leaves"));
    ...
    void differentShapeProducesDifferentKeys() {
        BonsaiPartCacheKey a = new BonsaiPartCacheKey(
                BonsaiBlockEntity.Shape.SEMI_CASCADE, false, OAK, ResourceLocation.withDefaultNamespace("oak_leaves"));
        BonsaiPartCacheKey b = new BonsaiPartCacheKey(
                BonsaiBlockEntity.Shape.SLANTING, false, OAK, ResourceLocation.withDefaultNamespace("oak_leaves"));
        assertNotEquals(a, b);
    }
    ...
    void deadFlagSeparatesKeys() {
        BonsaiPartCacheKey a = new BonsaiPartCacheKey(
                BonsaiBlockEntity.Shape.SEMI_CASCADE, false, OAK, ResourceLocation.withDefaultNamespace("oak_leaves"));
        BonsaiPartCacheKey b = new BonsaiPartCacheKey(
                BonsaiBlockEntity.Shape.SEMI_CASCADE, true, OAK, ResourceLocation.withDefaultNamespace("oak_leaves"));
        assertNotEquals(a, b);
    }
    ...
    void differentTrunkProducesDifferentKeys() {
        BonsaiPartCacheKey a = new BonsaiPartCacheKey(
                BonsaiBlockEntity.Shape.SEMI_CASCADE, false, OAK, ResourceLocation.withDefaultNamespace("oak_leaves"));
        BonsaiPartCacheKey b = new BonsaiPartCacheKey(
                BonsaiBlockEntity.Shape.SEMI_CASCADE, false, MAPLE, ResourceLocation.withDefaultNamespace("oak_leaves"));
        assertNotEquals(a, b);
    }
    ...
    void differentLeavesProduceDifferentKeys() {
        BonsaiPartCacheKey a = new BonsaiPartCacheKey(
                BonsaiBlockEntity.Shape.SEMI_CASCADE, false, OAK, ResourceLocation.withDefaultNamespace("oak_leaves"));
        BonsaiPartCacheKey b = new BonsaiPartCacheKey(
                BonsaiBlockEntity.Shape.SEMI_CASCADE, false, OAK, ResourceLocation.withDefaultNamespace("maple_leaves"));
        assertNotEquals(a, b);
    }
    ...
    void deadTreesIgnoreLeavesInCacheKey() {
        BonsaiPartCacheKey oak = new BonsaiPartCacheKey(
                BonsaiBlockEntity.Shape.TWIN, true, OAK, ResourceLocation.withDefaultNamespace("oak_leaves"));
        BonsaiPartCacheKey maple = new BonsaiPartCacheKey(
                BonsaiBlockEntity.Shape.TWIN, true, OAK, ResourceLocation.withDefaultNamespace("maple_leaves"));
